...
namespace Onnx
{
    public class VersionTableType
    {
        ...
        public VersionTableType(string release_version, int ir_version, int onnx_version, int onnx_ml_version, int? tranining_version = null)
        {
